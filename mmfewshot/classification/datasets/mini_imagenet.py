...
ALL_CLASSES = [
    ...
    'n03527444', 'n04443257', 'n02108915', 'n02120079', 'n02138441',
    'n02981792', 'n02174001', 'n03535780', 'n03770439', 'n03773504',
    'n02950826', 'n03980874', 'n02114548', 'n03584254', 'n02091244',
    'n03417042', 'n02971356', 'n01855672', 'n09256479', 'n03075370',
        ...
        for subset_ in self.subset:
            ...
            with open(ann_file, 'r') as f:
                for i, line in enumerate(f):
                    ...
                    # modify to:
                    # filename = f'{class_name}_{filename.split(".")[0][-5:]}.jpg'
