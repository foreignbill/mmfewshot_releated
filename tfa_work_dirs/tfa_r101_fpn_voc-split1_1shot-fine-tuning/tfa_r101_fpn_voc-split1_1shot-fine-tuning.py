...
log_level = 'INFO'
load_from = 'work_dirs/tfa_r101_fpn_voc-split1_base-training/base_model_random_init_bbox_head.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tfa_r101_fpn_voc-split1_1shot-fine-tuning'
gpu_ids = [0]
